...
<div class="row m-0 mt-5 panel">
    ...
    <div class="profile-text col-lg-9 col-md-8 p-md-0 mb-2">
        ...
        @if(\App\Perusahaan::getIsVerified($rekrut->perusahaan_id))
...
@section('content')
    <ol class="breadcrumb p-1 ml-auto">
        ...
        <li class="breadcrumb-item"><a href="{{ route('perekrutan.lamaranlist') }}">Daftar Lamaran</a></li>
    ...
    <h5 class="mb-2 p-0">
        ...
        <a class="btn btn-outline-info p-1 mr-1 float-right" href="{{ route('perekrutan.printdetailpelamar', ['id' => $rekrut->rekrut_id]) }}">
            <small><i class="fas fa-file-pdf"></i> Cetak Detail Lamaran</small>
        </a>
    </h5>
    <!-- lamaran status -->
