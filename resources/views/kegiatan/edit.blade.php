...
<form method="post" id="formadd" action="{{ route('kegiatan.update') }}" enctype="multipart/form-data">
@csrf
    <!-- add form -->
    <h5 class="mb-2 p-0">
        Edit Kegiatan
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="descKegiatan" class="form-control" placeholder="Deskripsi Kegiatan" name="kegiatan_desc" required="required"
                            ...
                            data-parsley-required-message="Masukan deskripsi kegiatan">{{ htmlspecialchars_decode($kegiatan->kegiatan_desc) }}</textarea>
                        @error('kegiatan_desc')
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="alert alert-warning">
                            Kegiatan ini sudah diverifikasi pada {{ date('d F Y', strtotime($kegiatan->kegiatan_verify_mentor)) }}.<br />
                            Mengubah kegiatan akan membutuhkan verifikasi ulang dari mentor magang anda.
                        </div>
                        @endif
                        <div class="row">
                            <div class="col-6">
                                <input type="button" class="btn btn-danger btn-block" value="Hapus Kegiatan" id="btnHapus">
                            </div>
                            <div class="col-6 pl-0">
                                <input type="button" class="btn btn-success btn-block" value="Simpan Perubahan" id="btnSimpan">
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <div class="modal fade" id="confirmModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin untuk menyimpan perubahan pada kegiatan ini?
            </div>
...
<div class="modal fade" id="hapusModal">
    ...
    <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
            Apakah anda yakin untuk menghapus kegiatan pada tanggal {{ date('d F Y', strtotime($kegiatan->kegiatan_tgl)) }} ?
        </div>
        ...
        <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="{{ url('kegiatan/delete/'.$kegiatan->kegiatan_tgl) }}">Ya</a>
        </div>
