@extends('layouts.front', ['Import Mahasiswa - MagangHub'])
...
@section('content')
    <ol class="breadcrumb p-1 ml-auto">
        ...
        <li class="breadcrumb-item"><a href="{{ route('mahasiswa.manage') }}">Kelola Mahasiswa</a></li>
...
<form method="post" id="formadd" action="{{ route('mahasiswa.import') }}" enctype="multipart/form-data">
@csrf
    <!-- import form -->
    <h5 class="mb-2 p-0">
        Import Mahasiswa
    ...
    <div class="bg-white shadow-sm border px-2 px-lg-3 py-3 mb-3">
        ...
        <table class="table table-sm" cellspacing="0">
            <tr>
                ...
                <td>
                    <div class="alert alert-info">
                        Import data mahasiswa akan melakukan proses tambah mahasiswa secara bulk data.<br />
                        Sama seperti tambah mahasiswa, jika ada daftar NIM atau e-mail yang sudah terdaftar, daftar tersebut akan dilewati.
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-success p-1" href="{{ asset('template/template_import_mahasiswa.csv') }}"> 
            ...
            <tr>
                ...
                <td>
                    <input type="button" class="btn btn-success btn-block" value="Import Mahasiswa" id="btnsubmit" data-toggle="modal" data-target="#confirmModal">
                </td>
            </tr>
        </table>
    ...
    <div class="modal fade" id="confirmModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah anda yakin untuk import data mahasiswa?
            </div>
